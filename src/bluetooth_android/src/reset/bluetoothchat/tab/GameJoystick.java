...
public class GameJoystick {
	...
	public int get_joystick_bg_width()     {
		return _joystickBg.getWidth();		
	}
	
	public int get_joystick_bg_height()     {
		return _joystickBg.getHeight();		
	}
	
	public int get_joystick_width()     {
		return _joystick.getWidth();		
	}
	
	public int get_joystick_height()     {
		return _joystick.getHeight();		
	}
}
